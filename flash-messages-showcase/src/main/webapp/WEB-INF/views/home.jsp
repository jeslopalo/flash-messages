...
<section class="container">
    <header class="page-header">
        <h1>Flash Messages Showcase
            <small>for spring mvc</small>
        </h1>
    </header>
    <div class="row">
        <div class="col-md-6">
            ...
            <p><a href="/status/demo/exception">Controller exception!</a> /exception -E(m)-&gt; @ExceptionHandler
                -F(m,m)-&gt; /home</p>

            <p><a href="/status/demo/global-exception">Global controller exception!</a> /global-exception -E(m)-&gt;
                @ExceptionHandler -F(m,m)-&gt; /home</p>
        </div>
        <div class="col-md-6">
            <flash:messages/>
        </div>
