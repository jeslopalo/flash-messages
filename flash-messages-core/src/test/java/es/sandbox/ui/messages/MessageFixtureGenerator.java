...
public class MessageFixtureGenerator {
	...
	public static final MessageFixtureGenerator fixturer() {
		return new MessageFixtureGenerator();
	}

	private MessageFixtureGenerator() {
	}


	public MessageFixtureGenerator withTimestamps(final DateTime... timestamps) {
		this.timestamps= Arrays.asList(timestamps);
		this.timestampsIterator= this.timestamps.iterator();
		return this;
	}

	public MessageFixtureGenerator withLevels(Level... levels) {
		this.levels= Arrays.asList(levels);
		this.levelsIterator= this.levels.iterator();
		return this;
	}

	public MessageFixtureGenerator withMessages(final String... messages) {
